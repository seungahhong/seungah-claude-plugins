...
> P1·P4·P5 신호의 근거: context engineering(최소·고신호) / Agent Skills best-practices. 중복·비대는 `rule-body-cost`만 올리므로 제거·이관이 Pareto 비후퇴 승리다. 단, 삭제·이관 patch도 승인 게이트를 거치고 **안전장치는 제거 표적으로 삼지 않는다(P2)**.
