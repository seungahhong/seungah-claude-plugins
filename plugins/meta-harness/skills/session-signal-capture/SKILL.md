...
| active SKILL | 그 산출을 만든 시점에 로드돼 있던 skill 식별자(예: `frontend-harness:tdd`). 미상이면 `unknown`으로 명시(누락 금지) |
...
{"ts":"2026-06-03T10:11:50Z","actor":"skill:frontend-harness:semantic-html","kind":"active-skill","ref":"loaded@msg#38","raw":"active skill: semantic-html (직전 산출이 따른 절차/포맷 근거)","confidence":"high"}
```
